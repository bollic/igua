...
server.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://average-cape-pig.cyclic.app/'); // Allow any origin
...
app.use(cors({
  origin:  ['*','http://localhost:8000', 'http://localhost:4000/posts'], // use your actual domain name (or localhost), using * is not recommended
